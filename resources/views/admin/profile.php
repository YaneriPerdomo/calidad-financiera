                        ...
                        <div class="form__row form__row--account-data row ">
                            ...
                            <div class="form__col form__col--inputs col-lg-8 col-12">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text form__icon" id="username-icon"><i
                                    ...
                                    <input type="text" name="user" class="form-control form__input form__input--item "
                                        ...
                                        aria-describedby="username-icon" value="<?php echo $data['usuario'] ?? '' ?>">
                                </div>
                                <label for="account-type" class="form__label  ">Tipo de
                                    cuenta</label><br>
                                <div class="input-group mb-3">
                                    <span class="input-group-text form__icon" id="account-type-icon"><i
                                            class="bi bi-card-checklist"></i></i></span>
                                    <input type="text" name="account-type"
                                        ...
                                        aria-describedby="account-type-icon" value="" disabled>
                                </div>
                            </div>
                        </div>
                    </div>

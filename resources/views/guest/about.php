...
<body>
    ...
    <main class="main">
        ...
        ?>
        <div class="w-100 h-100-p content--admin-about">
            <article class="about">
                <div class="row about__row">
                    <div class="col-lg-6 col-12 about__col--left">
                        <div class="about-us">
                            <h1 class="about-us__title"><strong>Acerca de nosotros</strong></h1>
                            <p class="about-us__description">En primera instancia con la aplicacion web llamada <i
                                    class="font-bold">calidad financiera</i> está diseñado
                                ...
                                y, al mismo tiempo, brindando a los huéspedes la oportunidad de ver su progreso con un
                                seguimiento seguro.
                            </p>
                        </div>
                        <div class="available-services">
                            ...
                            <ol class="available-services__list">
                                ...
                                <li class="available-services__item">Controlar su progreso financiero, como saldo,
                                    ahorros, ingresos y gastos, mensual y anualmente, y consulte presupuestos mensuales
                                    y más.</li>
                                <li class="available-services__item">
                                    Gestionar a los invitados que desee para que puedan ver su progreso financiero de
                                    forma segura, estableciendo restricciones.
                                </li>
                            </ol>
                        </div>
                    </div>

            ...
            <div class="col-12 col-lg-8 form__col form__col--inputs">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" name="password"
                        class="form__input form__input--item form-control" placeholder="Crea una contraseña segura"
                        aria-label="Contraseña" aria-describedby="basic-addon1" value="">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" name="confirm-password"
                        ...
                        aria-label="Confirmar contraseña" aria-describedby="basic-addon1" value="">
                </div>
            </div>
        </div>
    </div>

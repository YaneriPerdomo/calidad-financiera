...
class AdminModel extends Database
{
    ...
    public function ShowSearchUsers($searchUsers, $page = 1)
    {
        ...
        <button class='  button--delete' data-model='js' data-id-user='".$row['id_usuario']."' 
        data-id-person='".$row['id_persona']."'>
    ...
    {
        $total_users_query = 'SELECT count(usuario) AS total_users FROM `usuarios_cf` 
        WHERE NOT id_usuario = 1 AND NOT id_rol = 3';
